...
This project is an AI-based application that generates short stories from images, translates them into Hungarian, and reads aloud the English version since the Hungarian TTS is a bit cooked at the moment.
